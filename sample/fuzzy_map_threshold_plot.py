...
output_path = '/home/aitor/localizationpy/output/fuzzy_map_th_plot/'
...
#     "aerials": ['1', '2', '3', '4'],
#     "threshold": threshold,
#     "subplot_name": 'Aerial 1-4, threshold:{}dB'.format(threshold),
#     "output": output_path + 'aerial_1-4.csv',
#     "power_output": output_path + 'aerial_1-4_powers.csv'
# })
...
configs.append({
    "aerials": ['1'],
    "threshold": threshold,
    "subplot_name": 'Aerial 1, threshold:{}dB'.format(threshold),
    "output": output_path + 'aerial_1.csv',
    "power_output": output_path + 'aerial_1_powers.csv'
})
...
configs.append({
    "aerials": ['2'],
    "threshold": threshold,
    "subplot_name": 'Aerial 2, threshold:{}dB'.format(threshold),
    "output": output_path + 'aerial_2.csv',
    "power_output": output_path + 'aerial_2_powers.csv'
})
...
configs.append({
    "aerials": ['3'],
    "threshold": threshold,
    "subplot_name": 'Aerial 3, threshold:{}dB'.format(threshold),
    "output": output_path + 'aerial_3.csv',
    "power_output": output_path + 'aerial_3_powers.csv'
})
...
configs.append({
    "aerials": ['4'],
    "threshold": threshold,
    "subplot_name": 'Aerial 4, threshold:{}dB'.format(threshold),
    "output": output_path + 'aerial_4.csv',
    "power_output": output_path + 'aerial_4_powers.csv'
})
...
# fig.savefig(output_path + 'plot_1-4.png', bbox_inches='tight', dpi=150)
# plt.show()
